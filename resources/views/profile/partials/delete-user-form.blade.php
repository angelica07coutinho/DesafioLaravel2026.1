<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-[#a066a6]">
            {{ __('Uma vez que sua conta for deletada, todos os seus recursos e dados serão permanentemente excluídos. Antes de deletar sua conta, por favor, baixe quaisquer dados ou informações que deseje manter.') }}
        </p>
    </header>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <h2 class="text-lg font-medium text-[#4a0051]">
