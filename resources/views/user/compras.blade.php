<x-app-layout>
    <div class="flex flex-col-reverse gap-8 max-w-4xl mx-auto py-8">
        @foreach ($compras as $compra)
            <div class="flex flex-col bg-[#4a0051c3] gap-2 p-3 border-2 border-[#a066a6] rounded-lg">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-2">
                        <p class="text-md text-[#f8e9f9] mt-2">Total: </p>
                        <p class="text-lg font-semibold text-[#c593ca] mt-2">R$ {{ number_format($compra->total, 2, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        @endforeach
